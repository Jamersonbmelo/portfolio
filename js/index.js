...
document.addEventListener("DOMContentLoaded", () => {
    new TypeIt(".texto-automatico", {
      ...
      .type("Eu sou o Jamerson Melo!", { delay: 600 })
      .type(" ")
      .pause(300)
      .delete(3)
      .type("o!", { delay: 100 })
  ...
  var mostrarHTML = document.getElementById("vue");
  mostrarHTML.addEventListener("mouseover", function () {
    var titulo = document.querySelector(".tecnologia-nome");
    var significado = document.querySelector(".tecnologia-sobre");
    titulo.innerHTML = "Vue.JS";
    significado.innerHTML = "O Vue. JS é um framework progressivo de código aberto que constrói interfaces de usuário (UI). Desde a instituição, a ferramenta serve tecnicamente para adoção de forma incremental, podendo ser dimensionado entre uma biblioteca e uma estrutura, a depender do uso!";
  });
